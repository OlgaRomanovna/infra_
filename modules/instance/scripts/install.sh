...
cd /opt/
git clone https://github.com/OlgaRomanovna/kubernetes_setup.git
cd kubernetes_setup/
git clone https://github.com/OlgaRomanovna/kubespray.git
...
mv /home/ubuntu/variables.tf /opt/kubernetes_setup/terraform/variables.tf
